...
Vagrant.configure("2") do |config|
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/salinqas"
  #   chef.validation_client_name = "salinqas-validator"
  #   chef.validation_key_path = ".chef/salinqas-validator.pem"
  # end
end
